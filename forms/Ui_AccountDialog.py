...
class Ui_AccountDialog(QDialog):
    ...
    def setupUi(self, AccountDialog):
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 87, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(AccountDialog)
        self.groupBox_2.setMaximumSize(QtCore.QSize(16777215, 192))
        font = QtGui.QFont()
        ...
        self.verticalLayout_8.setContentsMargins(0, 9, 9, 0)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 30, 278, 27))
        ...
        self.buttonBox.rejected.connect(AccountDialog.reject)
        self.buttonBox.accepted.connect(AccountDialog.accept)
    ...
    def retranslateUi(self, AccountDialog):
        ...
        self.groupBox_2.setTitle(_translate("AccountDialog", "Статистка:"))
    ...
    def getData(parent = None):
        dialog = Ui_AccountDialog(parent)
        dialog.setupUi(dialog)
        result = dialog.exec_()
        data = dialog.getSettings()
